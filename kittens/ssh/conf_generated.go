...
func Parse_Askpass(val string) (ans Askpass_Choice_Type, err error) {
	switch val {
	case "unless-set":
		return Askpass_unless_set, nil
	case "ssh":
		return Askpass_ssh, nil
	case "native":
		return Askpass_native, nil
	default:
		return ans, fmt.Errorf("%#v is not a valid value for %s. Valid values are: %s", val, "native", "unless-set, ssh, native")
	}
}
...
func (x Remote_kitty_Choice_Type) String() string {
	...
	default:
		return ""
	case Remote_kitty_if_needed:
		return "if-needed"
	case Remote_kitty_no:
		return "no"
	case Remote_kitty_yes:
		return "yes"
	}
}
func Parse_Remote_kitty(val string) (ans Remote_kitty_Choice_Type, err error) {
	switch val {
	case "if-needed":
		return Remote_kitty_if_needed, nil
	case "no":
		return Remote_kitty_no, nil
	case "yes":
		return Remote_kitty_yes, nil
	default:
		return ans, fmt.Errorf("%#v is not a valid value for %s. Valid values are: %s", val, "yes", "if-needed, no, yes")
	}
}
func (c *Config) Parse(key, val string) (err error) {
	...
	case "askpass":
		...
		if err != nil {
			return fmt.Errorf("Failed to parse askpass = %#v with error: %w", val, err)
		}
		c.Askpass = temp_val
	case "color_scheme":
		var temp_val string
		...
		if err != nil {
			return fmt.Errorf("Failed to parse color_scheme = %#v with error: %w", val, err)
		}
	...
	case "copy":
		...
		if err != nil {
			return fmt.Errorf("Failed to parse copy = %#v with error: %w", val, err)
		}
	...
	case "cwd":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse cwd = %#v with error: %w", val, err)
		}
		c.Cwd = temp_val
	case "delegate":
		var temp_val string
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse delegate = %#v with error: %w", val, err)
		}
		c.Delegate = temp_val
	case "env":
		...
		if err != nil {
			return fmt.Errorf("Failed to parse env = %#v with error: %w", val, err)
		}
	...
	case "forward_remote_control":
		...
		if err != nil {
			return fmt.Errorf("Failed to parse forward_remote_control = %#v with error: %w", val, err)
		}
	...
	case "hostname":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse hostname = %#v with error: %w", val, err)
		}
		c.Hostname = temp_val
	case "interpreter":
		var temp_val string
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse interpreter = %#v with error: %w", val, err)
		}
	...
	case "login_shell":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse login_shell = %#v with error: %w", val, err)
		}
	...
	case "password":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse password = %#v with error: %w", val, err)
		}
		c.Password = temp_val
	case "remote_dir":
		var temp_val string
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse remote_dir = %#v with error: %w", val, err)
		}
	...
	case "remote_kitty":
		...
		if err != nil {
			return fmt.Errorf("Failed to parse remote_kitty = %#v with error: %w", val, err)
		}
	...
	case "share_connections":
		...
		temp_val, err = config.StringToBool(val), nil
		if err != nil {
			return fmt.Errorf("Failed to parse share_connections = %#v with error: %w", val, err)
		}
	...
	case "shell_integration":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse shell_integration = %#v with error: %w", val, err)
		}
	...
	case "terminfo_dir":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse terminfo_dir = %#v with error: %w", val, err)
		}
		c.Terminfo_dir = temp_val
	case "totp_digits":
		var temp_val int64
	...
	case "totp_secret":
		...
		temp_val, err = val, nil
		if err != nil {
			return fmt.Errorf("Failed to parse totp_secret = %#v with error: %w", val, err)
		}
