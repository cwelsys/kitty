...
class CwdPolicy(BaseTest):
    ...
    def test_choose_cwd_current_prefers_reported(self):
        ...
        self.ae(
            choose_cwd(reported='/home/u/proj', child_is_remote=False, at_prompt=False, foreground_is_nested_shell=False, heuristic_cwd='/', mode='current'),
            '/home/u/proj',
        )
    ...
    def test_choose_cwd_current_nested_shell_uses_heuristic(self):
        ...
        self.ae(
            choose_cwd(reported='/home/u/proj', child_is_remote=False, at_prompt=False, foreground_is_nested_shell=True, heuristic_cwd='/etc', mode='current'),
            '/etc',
        )
    ...
    def test_choose_cwd_current_remote_uses_heuristic(self):
        ...
        self.ae(
            choose_cwd(
                reported='/home/u/proj', child_is_remote=True, at_prompt=False, foreground_is_nested_shell=False, heuristic_cwd='/local', mode='current'
            ),
            '/local',
        )
    ...
    def test_choose_cwd_current_no_osc7_uses_heuristic(self):
        ...
        self.ae(
            choose_cwd(reported='', child_is_remote=False, at_prompt=False, foreground_is_nested_shell=False, heuristic_cwd='/proc/cwd', mode='current'),
            '/proc/cwd',
        )
    ...
    def test_choose_cwd_last_reported_forces_reported(self):
        ...
        self.ae(
            choose_cwd(
                reported='/home/u/proj', child_is_remote=False, at_prompt=False, foreground_is_nested_shell=True, heuristic_cwd='/x', mode='last_reported'
            ),
            '/home/u/proj',
        )
        # but not when remote
        self.ae(
            choose_cwd(
                reported='/home/u/proj', child_is_remote=True, at_prompt=False, foreground_is_nested_shell=False, heuristic_cwd='/x', mode='last_reported'
            ),
            '/x',
        )
    ...
    def test_choose_cwd_prompt_gated(self):
        ...
        self.ae(
            choose_cwd(
                reported='/home/u/proj', child_is_remote=False, at_prompt=True, foreground_is_nested_shell=False, heuristic_cwd='/h', mode='prompt_gated'
            ),
            '/home/u/proj',
        )
        ...
        self.ae(
            choose_cwd(
                reported='/home/u/proj', child_is_remote=False, at_prompt=False, foreground_is_nested_shell=False, heuristic_cwd='/h', mode='prompt_gated'
            ),
            '/h',
        )
    ...
    def _fake_window(self, **kw):
        ...
        fake.resolved_cwd = lambda oldest=False, request_type=None: (
            Window.resolved_cwd(fake, oldest) if request_type is None else Window.resolved_cwd(fake, oldest, request_type)
        )
        return fake
